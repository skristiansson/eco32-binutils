...
#define lower_part 0x0000FFFF
#define higher_part 0xFFFF0000
...
/* is not needed because gcc takes care of this stuff
 * #define ECO32_RRX 	0x09	three registers, or two registers and a zero-extended halfword
 * #define ECO32_RRY 	0x0A	three registers, or two registers and a sign-extended halfword
*/
...
#define ECO32_RRS_ 	0x15	/*two registers and a sign-extended halfword*/
